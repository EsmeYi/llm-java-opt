...
MVN_PATH="/apps/Common/software/Maven/3.6.0/bin/mvn"
JAVA_PATH="/apps/Common/software/Java/21.0.5/bin/java"

LLAMA_PATH = "/mimer/NOBACKUP/groups/naiss2025-22-38/.cache/Meta-Llama-3.1-8B-Instruct/models--meta-llama--Meta-Llama-3.1-8B-Instruct/snapshots/0e9e39f249a16976918f6564b8830bc894c89659"
...
def imorove_code_deepseek(java_code: str) -> str:
    client = OpenAI(api_key="sk-2de3dd2aa6ea4284ba41eef60c1e1575", base_url="https://api.deepseek.com")
...
def run_pipeline():
    ...
    java_files = discover_files("TopK.java")
    for file_path in java_files:
